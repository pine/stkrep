...
public enum Column {
    ...
    TREND_SIGNAL(new TextEnumMapper(Report::trendSignal)),
    RISK_ON(new TextEnumMapper(Report::riskOn)),
    RATING(new TextEnumMapper(Report::rating)),
    PRICE_BY_ANALYST(new TextEnumMapper(Report::priceByAnalyst)),
    PRICE_BY_PBR(new TextEnumMapper(Report::priceByPbr)),
    PRICE_BY_PER(new TextEnumMapper(Report::priceByPer)),
