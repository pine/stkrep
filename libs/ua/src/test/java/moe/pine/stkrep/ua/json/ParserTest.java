...
public class ParserTest {
    ...
    void parseTest() {
        ...
        final List<UserAgent> userAgents =
                List.of(new UserAgent("13.4%", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.69 Safari/537.36", "Chrome 95.0 Win10"),
