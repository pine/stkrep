...
public class Extractors {
    ...
    public static final Extractor<ColoredText> FORECAST_BY_PBR_EXTRACTOR = new KarteExtractor("PBR基準");
    public static final Extractor<ColoredText> FORECAST_BY_PER_EXTRACTOR = new KarteExtractor("PER基準");
