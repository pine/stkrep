...
public class Extractors {
    ...
    public static final Extractor<String> PER_YIELD = new SummaryBoxStringExtractor("PER");
    public static final Extractor<String> PBR_YIELD = new SummaryBoxStringExtractor("PBR");
